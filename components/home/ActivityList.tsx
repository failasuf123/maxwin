      ...
      <div className="relative h-3/5 w-full">
        ...
        <div className="absolute bottom-2 left-2">
          <img src={itinerary?.userPicture || "/placeholder.webp" }
            className="h-7 w-7 rounded-lg  md:hidden group-hover:rounded-sm" alt={itinerary.tripData.username} />
        </div>
      </div>
      <div className="flex flex-col items-center p-2 overflow-hidden text-sm text-gray-500">
        <div className="flex flex-row items-center gap-2">
          <img src={itinerary?.userPicture || "/placeholder.webp" } className="h-9 w-9 rounded-full hidden md:block"
