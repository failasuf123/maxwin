...
interface ContainerWisataProps {
  name: string;
  description: string;
  cost: number;
  timeStart: string;
  ...
  image: string;
  imageList: string[];
  allImageDetails: { image: string; name: string }[];
}
      ...
      <div className="p-3 rounded-lg flex flex-row items-start gap-4 relative">
        ...
        <div className="flex-1">
          <div className="flex flex-row items-center justify-between gap-2 w-full">
            ...
            <div className="hidden md:flex items-center px-3 py-1 bg-gray-800 text-white rounded cursor-pointer hover:bg-gray-700 flex-shrink-0">
              + Bucket Trip
            </div>

            <div className="flex md:hidden items-center flex row rounded-full text-[10px] px-1 py-1 flex-shrink-0">
              <FiShoppingBag /> +
            </div>
          </div>
...
export default ContainerWisata;
